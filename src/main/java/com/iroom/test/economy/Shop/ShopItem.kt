...
class ShopItem(var material: Material, var price: Int) {
    ...
    companion object
    {
        ...
        fun initItemList()
        {
            ...
            ItemList.add(ShopItem(Material.OAK_LOG,15,uncommon))
            ItemList.add(ShopItem(Material.SPRUCE_LOG,15,uncommon))
            ItemList.add(ShopItem(Material.BIRCH_LOG,15,uncommon))
            ItemList.add(ShopItem(Material.JUNGLE_LOG,15,uncommon))
            ItemList.add(ShopItem(Material.ACACIA_LOG,15,uncommon))
            ItemList.add(ShopItem(Material.DARK_OAK_LOG,15,uncommon))
            ItemList.add(ShopItem(Material.CRIMSON_STEM,15,uncommon))
            ItemList.add(ShopItem(Material.WARPED_STEM,15,uncommon))
            ItemList.add(ShopItem(Material.OAK_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.SPRUCE_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.BIRCH_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.JUNGLE_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.ACACIA_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.DARK_OAK_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.CRIMSON_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.WARPED_PLANKS,4,uncommon))
            ItemList.add(ShopItem(Material.STONE,1,uncommon))
            ItemList.add(ShopItem(Material.COBBLESTONE,1,common))
            ItemList.add(ShopItem(Material.MOSSY_COBBLESTONE,1,uncommon))
            ItemList.add(ShopItem(Material.STONE_BRICKS,2,uncommon))
            ItemList.add(ShopItem(Material.MOSSY_STONE_BRICKS,2,uncommon))
            ItemList.add(ShopItem(Material.CRACKED_STONE_BRICKS,2,uncommon))
            ItemList.add(ShopItem(Material.CHISELED_STONE_BRICKS,2,uncommon))
            ItemList.add(ShopItem(Material.SMOOTH_STONE,3,uncommon))
            ItemList.add(ShopItem(Material.SANDSTONE,1,uncommon))
            ItemList.add(ShopItem(Material.RED_SANDSTONE,1,uncommon))
            ItemList.add(ShopItem(Material.GRANITE,1,common))
            ItemList.add(ShopItem(Material.POLISHED_GRANITE,1,uncommon))
            ItemList.add(ShopItem(Material.ANDESITE,1,common))
            ItemList.add(ShopItem(Material.POLISHED_ANDESITE,1,uncommon))
            ItemList.add(ShopItem(Material.DIORITE,1,common))
            ItemList.add(ShopItem(Material.POLISHED_DIORITE,1,uncommon))
            ItemList.add(ShopItem(Material.BRICKS,3,uncommon))
            ItemList.add(ShopItem(Material.PRISMARINE,3,uncommon))
            ItemList.add(ShopItem(Material.PRISMARINE_BRICKS,3,uncommon))
            ItemList.add(ShopItem(Material.DARK_PRISMARINE,5,uncommon))
            ItemList.add(ShopItem(Material.QUARTZ_BLOCK,5,rare))
            ItemList.add(ShopItem(Material.NETHER_BRICKS,3,uncommon))
            ItemList.add(ShopItem(Material.RED_NETHER_BRICKS,3,uncommon))
            ItemList.add(ShopItem(Material.BLACKSTONE,1,common))
            ItemList.add(ShopItem(Material.POLISHED_BLACKSTONE,1,common))
            ItemList.add(ShopItem(Material.BASALT,1,common))
            ItemList.add(ShopItem(Material.POLISHED_BASALT,1,common))
            ItemList.add(ShopItem(Material.END_STONE,1,common))
            ItemList.add(ShopItem(Material.PURPUR_BLOCK,1,uncommon))
            ItemList.add(ShopItem(Material.DIRT,1,common))
            ItemList.add(ShopItem(Material.COARSE_DIRT,1,common))
            ItemList.add(ShopItem(Material.GRASS_BLOCK,2,uncommon))
            ItemList.add(ShopItem(Material.MYCELIUM,3,uncommon))
            ItemList.add(ShopItem(Material.PODZOL,3,uncommon))
            ItemList.add(ShopItem(Material.SAND,2,common))
            ItemList.add(ShopItem(Material.RED_SAND,2,common))
            ItemList.add(ShopItem(Material.GRAVEL,2,common))
            ItemList.add(ShopItem(Material.COAL_ORE,10,uncommon))
            ItemList.add(ShopItem(Material.IRON_ORE,300,rare))
            ItemList.add(ShopItem(Material.GOLD_ORE,100,rare))
            ItemList.add(ShopItem(Material.NETHER_GOLD_ORE,30,uncommon))
            ItemList.add(ShopItem(Material.DIAMOND_ORE,10000,unique))
